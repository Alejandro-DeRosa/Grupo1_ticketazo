...
describe('Login - Test Cases', () => {
    ...
    it('TC05 - Login con formato de email inválido', function () {
        ...
        passwordInput().type(this.users.invalidEmailFormat.password); loginButton().click();
        incorrectEmailOrPasswordErrorMessage().should('contain', 'Correo o contraseña incorrectos'); emailErrorMessage().should('contain.text', 'Incluye un signo "@" en la dirección de correo electrónico. La dirección "admin.com" no incluye el signo "@"');
    });
